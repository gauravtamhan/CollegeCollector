...
$(document).ready(function() {
    ...
    if (mobileAndTabletcheck()) { // yes its a mobile device

        if ($(window).load() && window.innerHeight > window.innerWidth) {
            $(".page-header").hide();
            $(".selection_area").hide();
            $("#map").hide();
            $("#info").hide();
    ...
    else { // no its not a mobile device
        d3.select("body").append("div")
        ...
        if ($(window).width() < 936 && $(window).load()) { // 1210
            $(".page-header").hide();
            $(".selection_area").hide();
            $("#map").hide();
            $("#info").hide();
        ...
        $(window).resize(function() {
            if ($(window).width() < 936 && $(window).load()) {
                $(".page-header").fadeOut();
